...
export const IssueRulesModal: React.FC<IssueRulesModalProps> = ({ onClose, onSuccess }) => {
    ...
    const handleDraftRule = async () => {
        ...
        try {
            ...
            const prompt = `
                As an expert legal and regulatory writer for the AYUSH ministry of India, draft a new formal rule based on the following topic. 
                The rule should be clear, concise, and legally sound, suitable for publishing as an official directive.
                Topic: "${ruleTopic}"
            ...
            console.error("Error drafting rule with Gemini API:", err);
            setError('Failed to draft the rule. Please check your API key and try again.');
        } finally {
            setIsLoading(false);
        }
    };
                ...
                <div className="p-6">
                    <div className="flex items-start justify-between pb-4 border-b">
                        <div>
                            ...
                            <p className="text-sm text-gray-500">Use AI to draft and then issue a new rule to the supply chain.</p>
                        </div>
                    ...
                    <div className="py-6 space-y-4">
                        ...
                        <div className="text-center">
                            ...
                            >
                                {isLoading ? <><SpinnerIcon className="w-5 h-5 mr-2" /> Drafting...</> : 'Draft Rule with AI'}
                            </button>
                        </div>
